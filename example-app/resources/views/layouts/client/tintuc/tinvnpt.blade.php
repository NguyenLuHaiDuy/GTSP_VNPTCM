    ...
    <div class="news-container">
        ...
        <div class="news-item">
            <div class="news-image">
                <img src="{{asset('assets/client/images/news/1.jpg')}}" alt="VNPT News 1">
            </div>
        ...
        <div class="news-item">
            <div class="news-image">
                <img src="{{asset('assets/client/images/news/2.jpg')}}" alt="VNPT News 2">
            </div>
            <div class="news-content">
        ...
        <div class="news-item">
            <div class="news-image">
                <img src="{{asset('assets/client/images/news/3.jpg')}}" alt="VNPT News 3">
            </div>
            <div class="news-content">
